...
import { useBackClose, ActivityTimeline, MileageView, RecruitingKpiTile, SingleContactPicker, confirmDialog, lbl, modal, stageMeta, TipFor } from '../App';
    ...
    <div className="page-shell ww-prism">
      ...
      <div className="page-header" style={{alignItems:'flex-start'}}>
        <div style={{flex:1,minWidth:0}}>
          <h2 style={{display:'flex',alignItems:'center',gap:'10px',margin:0,fontFamily:'Fraunces, serif',fontWeight:300,fontSize:'30px',letterSpacing:'-0.02em'}}><Icon name="deals" size={24} style={{color:'var(--accent)',flexShrink:0}} />Files</h2>
        </div>
