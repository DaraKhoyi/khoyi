  ...
  async function saveEmailTask() {
    ...
    try {
      const row = {
        ...
        priority_system: defaultSystem, eisenhower_quadrant: defaultSystem === 'eisenhower' ? ({ high: 'A', medium: 'B', low: 'C', none: 'D' }[taskPriority] || 'B') : null, eisenhower_rank: defaultSystem === 'eisenhower' ? 1 : null,
