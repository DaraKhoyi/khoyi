    ...
    <div>
      ...
      <div className="page-header fade-up" style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',flexWrap:'wrap',gap:'10px'}}>
        <div>
          ...
          <h2 style={{display:'flex',alignItems:'center',gap:'10px',margin:'0',fontFamily:'Fraunces, serif',fontWeight:300,fontSize:'30px',letterSpacing:'-0.02em'}}><Icon name="inbox" size={24} style={{color:'var(--accent)',flexShrink:0}} />My Correspondence</h2>
