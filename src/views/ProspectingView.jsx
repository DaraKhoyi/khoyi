    ...
    <div className="ww-prism" style={{ display: 'flex', flexDirection: 'column', gap: '14px', background:'radial-gradient(120% 26% at 50% -4%, rgba(203,163,92,.09), transparent 60%), #100D09', minHeight:'100%' }}>
      ...
      <div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px', flexWrap: 'wrap' }}>
          <h2 style={{ fontSize: '30px', fontWeight: 300, fontFamily: 'Fraunces, serif', letterSpacing: '-0.02em', margin: 0, display: 'flex', alignItems: 'center', gap: '10px' }}><Icon name="prospecting" size={24} style={{color:'var(--accent)',flexShrink:0}} />{
            sub === 'roi'     ? 'What Paid'
          : sub === 'library' ? 'My Lead Systems'
          : sub === 'systems' ? 'My Lead Systems'
          : "Today's Hunt"}</h2>
