      ...
      <div className="page-header fade-up" style={{marginBottom:'2px'}}>
       <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',gap:'10px'}}>
        <div style={{flex:1,minWidth:0}}>
          <span className="gold-move" style={{fontFamily:"'Barlow Condensed',sans-serif",textTransform:'uppercase',letterSpacing:'.22em',fontSize:'11px',fontWeight:700}}>Calendar</span>
          <h2 style={{display:'flex',alignItems:'center',gap:'10px',margin:'2px 0 0'}}><Icon name="calendar" size={24} style={{color:'var(--accent)',flexShrink:0}} />My Schedule</h2>
