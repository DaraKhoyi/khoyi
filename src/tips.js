...
export const TIPS = [
  ...
  { id: 'lp_gallery_trend_sources', screen: 'listing_presentation', label: 'Make it look listing-day sharp',
    body: 'Three touches that make the deck <i>feel</i> best-in-class: paste a few <b>gallery photo URLs</b> (one per line) to show the home at its best under the profile; the <b>12-month price trend</b> draws itself from the market\u2019s appreciation rate so the pricing has a backdrop; and the valuation now cites its <b>public sources</b> \u2014 exactly like an appraisal \u2014 so the seller sees the number is researched, not guessed.' },
