...
function AppMain() {
  ...
  // reason.
  const builtSet = new Set([...NAV.map(i => i.id), 'disc_test', 'disc_roster', 'myvoice', 'voice_roster', 'google_contacts', 'cadence_review', 'uncarded', 'unstuck', 'tags', 'correspondent', 'investor_transition', 'my_prism', 'production', 'transactions']);
