...
function applyMergeFields(text, { contact, deal, property, senderName } = {}) {
  if (!text) return text || '';
...
//     already added
function MultiContactPicker({ value, onChange, contacts, setContacts, currentContactId, userId, placeholder, defaultNewContactType = 'other' }) {
